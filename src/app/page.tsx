    ...
    <section className="px-4 max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-4xl mx-auto text-left mb-6">
          I am an Information Systems student with a strong interest in web development. I enjoy
          building web applications and learning how systems work from both technical and business
          perspectives. Currently, I am improving my skills in Laravel, PHP, JavaScript, HTML, and
          CSS through academic projects and hands-on practice.
        </p>
        ...
        <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-4xl mx-auto text-left">
          I am currently preparing myself for the MBKM internship program as a Web Developer. My
          focus is on developing functional and maintainable web applications while gaining
          real-world experience in collaborative development environments. I am eager to learn,
          contribute to a team, and grow professionally through industry-level projects.
        </p>
